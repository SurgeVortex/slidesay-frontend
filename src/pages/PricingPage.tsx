    ...
    <div className="pricing-page">
      ...
      <section className="pricing-faq">
        ...
        <details>
          ...
          <p>Your presentations are always safe. If you downgrade, you can still view and edit them in the browser. Export to PPTX/PDF requires an Educator or Pro plan.</p>
        </details>

        <details>
          <summary>Do you offer team plans?</summary>
          <p>Team plans are coming soon! For now, each user needs their own account. Contact us if you have specific team needs.</p>
        </details>

        <details>
          <summary>Is there a student discount?</summary>
          <p>Our Educator plan at $5/month is designed to be affordable for teachers and students alike. It includes everything you need for education use.</p>
        </details>

        <details>
          <summary>What payment methods do you accept?</summary>
          <p>We accept all major credit cards, debit cards, and PayPal through our payment processor Stripe.</p>
        </details>
      </section>
